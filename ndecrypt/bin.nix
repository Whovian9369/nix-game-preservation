...
stdenvNoCC.mkDerivation rec {
  ...
  src = fetchzip {
    url = "https://github.com/SabreTools/NDecrypt/releases/download/${version}/NDecrypt_${version}_net10.0_linux-x64_release.zip";
    hash = "sha256-2i06Z7N5oWNJ/SWvGKzNp4UsqTuvQGYayXAw+d3mUdg=";
    # stripRoot = false;
  };
